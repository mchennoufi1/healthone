...
try{
    ...
    ,"root");
    $query = $db->prepare("SELECT * FROM Product WHERE id = 6");
    $query->execute();
...
?>
<br>
<img id="roeitrainer1" src="img/categories/loopband/elb.jpg" width="400px" height="300px">
<br><br>
<?php
...
?>
<br>
<img id="roeitrainer1" src="img/categories/loopband/mlb.jpg" width="400px" height="300px">
<br><br>
